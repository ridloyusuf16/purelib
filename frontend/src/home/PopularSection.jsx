                ...
                <div className="row">
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item1.jpg"
                          alt="Books"
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item2.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item3.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item4.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                ...
                <div className="row">
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item5.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item6.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item7.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
                  ...
                  <div className="col-md-3">
                    <div className="product-item">
                      <figure className="product-style">
                        <img
                          src="src/assets/images/tab-item8.jpg"
                          alt="Books"
                          className="product-item"
                        />
                        <button
